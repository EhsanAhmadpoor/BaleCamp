...
const IssueModal = ({ handleCloseModal }: IssueModalProps) => {
  ...
  return (
    <div className={styles.modalContainer}>
      ...
      <div className={styles.modalControllers}>
        ...
        <button disabled={isLoading} className={styles.send} onClick={() => { dispatch(createIssueStart()); navigate('/issues') }}>ارسال</button>
      </div>
    </div>
  )
}
