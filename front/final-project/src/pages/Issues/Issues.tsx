...
const Issues = ({ isModalOpen, handleOpenModal, handleCloseModal, handleKeyPress }: IssuesProps) => {
  ...
  return (
    <>
          ...
          <div className={styles.sidebar}>
            <div className={styles.header}>
              ...
              <div className={styles.questionIcon}>
                <QuestionIcon onClick={() => dispatch(openInfoModal())} width={24} height={24} fill={`${theme === 'dark' ? "var(--issues-question-icon-dark)" : "var(--issues-question-icon)"}`} />
              </div>
            </div>
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal}>
        <IssueModal handleCloseModal={handleCloseModal} />
      </Modal>
      <Modal isOpen={isInfoModalOpen} onClose={() => dispatch(closeInfoModal())}>
        <InfoModal />
      </Modal>
      <Modal isOpen={isConfirmLogoutModalOpen} onClose={() => dispatch(closeConfirmModal())}>
        <ConfirmLogoutModal />
      </Modal>
      <Modal isOpen={isIssueEditModalOpen} onClose={handleCloseIssueEditModal}>
        <IssueEditModal handleCloseModal={handleCloseIssueEditModal} issueId={issueId} />
      </Modal>
